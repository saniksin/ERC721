...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    mapping(address owner => mapping(uint tokenIndex => uint)) private _ownedTokens;
    ...
    function _addTokenToOwnerEnumeration(address to, uint tokenId) private {
        uint _lenght = balanceOf(to);

        _ownedTokensIndex[tokenId] = _lenght;
        _ownedTokens[to][_lenght] = tokenId;
    }
